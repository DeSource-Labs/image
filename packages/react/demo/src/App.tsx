...
import { DsImage, DsImageProvider, DsPicture, useDsImageProps, useDsPictureProps } from '@desource/image-react';
...
function NativeImage({ width }: NativeMediaProps) {
  const imgProps = useDsImageProps({
    src: '/hero.jpg',
  ...
  return (
    <article>
      <span>useDsImageProps hook</span>
...
function NativePicture({ width }: NativeMediaProps) {
  ...
  return (
    <article>
      <span>useDsPictureProps hook</span>
