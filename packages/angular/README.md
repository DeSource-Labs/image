<div align="center">
  <h1>DeSource Image<br/>Optimized images for Angular</h1>
  <p><strong>High-quality image optimization with responsive, provider-first and SSR-friendly workflow for Angular.</strong></p>

  <p>
    <a href="https://www.npmjs.com/package/@desource/image-angular"><img src="https://img.shields.io/npm/v/@desource/image-angular?color=blue&logo=angular&logoColor=white" alt="npm version"></a>
