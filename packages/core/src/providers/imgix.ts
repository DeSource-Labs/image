...
const providerSetup = defineProvider<ImgixOptions>({
...
export type ImgixProviderOptions = Partial<ProviderOptionsOf<typeof providerSetup>>;

export function imgixProvider(options: ImgixProviderOptions = {}) {
  return configureProvider(providerSetup, options, 'imgix');
}
