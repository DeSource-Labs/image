...
export type BuilderioProviderOptions = Partial<ProviderOptionsOf<typeof providerSetup>>;

export function builderioProvider(options: BuilderioProviderOptions = {}) {
  return configureProvider(providerSetup, options, 'builderio');
}
