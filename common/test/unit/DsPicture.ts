...
export interface DsPictureComponentSetupResult {
  container: TestContainer;
  picture(): HTMLPictureElement;
  image(): HTMLImageElement;
  sources(): HTMLSourceElement[];
  preloadLinks(): HTMLLinkElement[];
  update(options: Partial<DsPictureComponentSetupOptions>): void | Promise<void>;
...
export type DsPictureComponentSetup = (
  options?: DsPictureComponentSetupOptions
) => DsPictureComponentSetupResult | Promise<DsPictureComponentSetupResult>;
